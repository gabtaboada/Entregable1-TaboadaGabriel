...
function renderSeleccionCombo(idPedido, combosArmados) {
    ...
    MenuSeleccion.innerHTML = "<p class='d-flex flex-column text-center titulo-seccion'>Seleccione la hamburguesa</p><div class='d-flex flex-column' id='ContenedorBurger'></div>"
...
function renderSubtotal() {
    ...
    const card = document.createElement("div")
    card.innerHTML = `<div class="card-subtotal-total">
